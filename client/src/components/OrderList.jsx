...
const OrderList = ({onSelectStock}) => {
  ...
  return (
    <div className="stock-list">
      ...
      {order.length === 0 && orderDetails.length === 0 && <div className="empty-state">No orders yet.</div>}
